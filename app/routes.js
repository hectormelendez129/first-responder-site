module.exports = function (app, passport, db) {
  ...
  /*****Incident mapping******/
  app.get('/api/incidents', isLoggedIn, (req, res) => { //<< makes incidents available for map.js
  ...
  app.post('/messages', (req, res) => { 
    db.collection('messages').save({ //must match profile.ejs inputs
       submittedBy: req.body.username, 
       startTime: req.body.startTime, //follow naming convention of profile.ejs 
